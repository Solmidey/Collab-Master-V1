...
- `src/config.ts`, `src/lib/snowflake.ts`: Strengthened Discord ID sanitization/validation to support raw IDs, mention strings, and channel URLs while blocking invalid values before startup.
